...
:mainEntry
REM set JAVA_OPTS
set "JAVA_OPTS=-server -Xms1024m -Xmx1024m -Xmn600m -Xss256k"
...
set "COBAR_CLASSPATH=%COBAR_CLASSPATH%;%COBAR_HOME%\lib\rocketmq-console-ng-2.0.0.jar"
set "COBAR_CLASSPATH=%COBAR_CLASSPATH%;%COBAR_HOME%\lib\spring-boot-2.2.2.RELEASE"

set COBAR_CLASSPATH=%COBAR_HOME%\conf;%COBAR_HOME%\lib\*;%CLASSPATH%
echo  %COBAR_CLASSPATH%  
...
set "RUN_CMD=%RUN_CMD% org.apache.rocketmq.console.RocketmqConsole"
call %RUN_CMD%            
