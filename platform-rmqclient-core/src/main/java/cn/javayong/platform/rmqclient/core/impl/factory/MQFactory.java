package cn.javayong.platform.rmqclient.core.impl.factory;

import cn.javayong.platform.rmqclient.core.MQFactoryAPI;
...
public class MQFactory {
    ...
    static {
        try {
            Class<?> hshcFactory = MQFactory.class.getClassLoader().loadClass("cn.javayong.platform.rmqclient.core.impl.factory.MQFactoryImpl");
