package cn.javayong.platform.rmqclient.core.utils;


import cn.javayong.platform.rmqclient.core.ProducerContext;
import cn.javayong.platform.rmqclient.core.ProducerMessage;
import cn.javayong.platform.rmqclient.core.SendResult;
import cn.javayong.platform.rmqclient.core.SendStatus;
...
public class MQUtil {
    ...
    public static SendCallback sendCallbackConvert(final ProducerMessage message,
                                                   final cn.javayong.platform.rmqclient.core.SendCallback sendCallback) {
