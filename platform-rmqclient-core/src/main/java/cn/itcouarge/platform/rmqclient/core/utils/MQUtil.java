package cn.itcouarge.platform.rmqclient.core.utils;


import cn.itcouarge.platform.rmqclient.core.ProducerContext;
import cn.itcouarge.platform.rmqclient.core.ProducerMessage;
import cn.itcouarge.platform.rmqclient.core.SendResult;
import cn.itcouarge.platform.rmqclient.core.SendStatus;
...
public class MQUtil {
    ...
    public static SendCallback sendCallbackConvert(final ProducerMessage message,
                                                   final cn.itcouarge.platform.rmqclient.core.SendCallback sendCallback) {
